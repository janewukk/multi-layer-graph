...
data2 = pd.read_csv("dataset/split_2012", header=None)
data3 = pd.read_csv("dataset/split_2013", header=None)
data = pd.read_csv("dataset/split_2014", header=None)
data1 = pd.read_csv("dataset/split_2015", header=None)
...
newId2_t = []
while i < len(data1[0]):
	newId2.append(id_dict[data1[0][i]])
	newId2_t.append(id_dict[data1[1][i]])
	i += 1
...
newId3_t = []
while i < len(data2[0]):
	newId3.append(id_dict[data2[0][i]])
	newId3_t.append(id_dict[data2[1][i]])
	i += 1
...
newId4_t = []
while i < len(data3[0]):
	newId4.append(id_dict[data3[0][i]])
	newId4_t.append(id_dict[data3[1][i]])
	i += 1
print("finished id4")
...
newId5_t = []
while i < len(data4[0]):
	newId5.append(id_dict[data4[0][i]])
	newId5_t.append(id_dict[data4[1][i]])
	i += 1
print("finished id5")
